...
//!
//! ```rust
//! use storage::query_builder::{QueryBuilder, Condition, SortOrder};
//!
...
impl QueryBuilder {
    ...
    ///
    /// ```rust
    /// use storage::query_builder::QueryBuilder;
    ///
    ...
    ///
    /// ```rust
    /// use storage::query_builder::{QueryBuilder, Condition};
    ///
    /// let builder = QueryBuilder::new("users")
    ...
    ///
    /// ```rust
    /// use storage::query_builder::{QueryBuilder, SortOrder};
    ///
    /// let builder = QueryBuilder::new("users")
    ///     .order_by("created_at", SortOrder::Desc);
    /// ```
