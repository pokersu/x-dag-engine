...
use model::{ExecutionContext, SubWorkflowConfig, Workflow};
...
pub struct SubWorkflowResult {
    pub output: Value,
    pub sub_workflow_id: model::WorkflowId,
    pub execution_state: model::ExecutionState,
