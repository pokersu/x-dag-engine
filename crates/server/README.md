...
`server` provides an HTTP server runtime for exposing orchestration workflows as REST APIs. Handles graceful shutdown, tracing, CORS, and compression.

## Usage

```rust
use server::{ServerRuntime, ServerConfig};
