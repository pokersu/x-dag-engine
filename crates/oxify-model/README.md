...
`oxify-model` provides the data structures for defining and managing API orchestration workflows as directed acyclic graphs (DAGs). Workflows are composed of typed nodes connected by edges, with support for conditional branching, loops, error handling, and parallel execution.
